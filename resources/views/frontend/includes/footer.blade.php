    ...
    @if ( ! Auth::guest() )
        ...
        <script src="{{ asset('js/plugins/datatables/dataTables.select.min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('js/plugins/datatables/jquery.dataTables.rowGrouping.js') }}" type="text/javascript"></script>
