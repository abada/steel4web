    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-padrao">
                <div class="panel-heading">Perfil de Usuário</div>
                            ...
                            <div role="tabpanel" class="tab-pane active" id="profile">
                                <table class="table table-striped table-hover table-bordered dashboard-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{!! route('frontend.user.perfil.editar') !!}" class="btn btn-primary btn-xs">{{ trans('labels.frontend.user.profile.edit_information') }}</a>
